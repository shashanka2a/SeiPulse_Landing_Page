      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-24">
          ...
          <Button
            asChild
            size="lg"
            className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 hover:scale-105 hover:shadow-xl hover:shadow-purple-400/30 text-white font-medium px-10 py-5 text-xl transition-all duration-300 rounded-full"
          >
